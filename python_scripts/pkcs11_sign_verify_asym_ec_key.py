...
description = '''
Perform a sign and verify using an asymmetric ec key
Example:
python3 pkcs11_sign_verify_asym_ec_key.py -p hunter2 -k key_name -f /path/to/file.txt'''
...
if search_result_priv and search_result_pub:
    ...
    mechanism.mechanism = LowLevel.CKM_ECDSA
