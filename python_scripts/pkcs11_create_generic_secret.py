# This program creates a generic secret for sign and verify operations
from PyKCS11 import LowLevel
import argparse

description = '''
Create a generic secret key for sign and verify operations
Example:
python3 pkcs11_create_generic_secret.py -p hunter2 -k generic_secret_key -n 256'''
...
if search_result:
    ...
    obj_template = LowLevel.ckattrlist(10)
    mechanism = LowLevel.CK_MECHANISM()
    mechanism.mechanism = LowLevel.CKM_GENERIC_SECRET_KEY_GEN
    ...
    obj_template[2].SetNum(LowLevel.CKA_KEY_TYPE, LowLevel.CKK_GENERIC_SECRET)
    ...
    obj_template[9].SetBool(LowLevel.CKA_SENSITIVE, True)
